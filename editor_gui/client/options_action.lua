...
function setEditorMoveSpeeds()
	...
	move_keyboard.setMoveSpeeds(
		dialog.slowElemMove:getValue(),
		dialog.normalElemMove:getValue(),
		dialog.fastElemMove:getValue()
	)
	--
	move_keyboard.setRotateSpeeds(
		dialog.slowElemRotate:getValue(),
		dialog.normalElemRotate:getValue(),
		dialog.fastElemRotate:getValue()
	)
	move_cursor.setRotateSpeeds(
		dialog.slowElemRotate:getValue(),
		dialog.normalElemRotate:getValue(),
		dialog.fastElemRotate:getValue()
	)
	move_freecam.setRotateSpeeds(
		dialog.slowElemRotate:getValue(),
		dialog.normalElemRotate:getValue(),
		dialog.fastElemRotate:getValue()
	)

	move_keyboard.setScalingSpeeds(
		dialog.slowElemScale:getValue(),
		dialog.normalElemScale:getValue(),
		dialog.fastElemScale:getValue()
	)
...
function optionsActions.debugEnabled(value)
	freecam.setFreecamOption("debugEnabled", value)
end

function optionsActions.debugShowObjectId(value)
	freecam.setFreecamOption("debugShowObjectId", value)
end

function optionsActions.debugShowObjectName(value)
	freecam.setFreecamOption("debugShowObjectName", value)
end

function optionsActions.debugShowObjectDistance(value)
	freecam.setFreecamOption("debugShowObjectDistance", value)
end

function optionsActions.debugDrawDistance(value)
	freecam.setFreecamOption("debugDrawDistance", value)
end

function optionsActions.debugMinTextScale(value)
	freecam.setFreecamOption("debugMinTextScale", value)
end

function optionsActions.debugMaxTextScale(value)
	freecam.setFreecamOption("debugMaxTextScale", value)
end
